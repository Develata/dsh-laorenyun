...
每个 proposal:
{"keySentence":"原文连续摘录，<=120字，禁止补词", "basis":"stated|inferred", "time":{"start":null,"end":null,"precision":"unknown","certainty":"stated","originalText":""},"evidence":[{"transcriptId":"本次transcript.id","text":"原文逐字引文","field":"claim"}],"people":[],"places":[],"edges":[]}。
